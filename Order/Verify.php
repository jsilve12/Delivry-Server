<?php
  ...
  try {
    $stmt = $pdo->prepare("INSERT INTO Order_Verified(placed_by, accepted_by, price, distance, charged, paid, address, addr_description, longitude, latitude, store) VALUES(:pb,:ab,:pr,:di,:ch,:pa,:ad,:ad_de,:lo,:la,:st)");
    $stmt->execute(array(
